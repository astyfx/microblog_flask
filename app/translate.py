import urlib, httplib
import json
from flask.ext.babel import gettext
from config import MS_TRANSLATOR_CLIENT_ID, MS_TRNASLATOR_CLIENT_SECRET

def microsoft_translate(text, sourceLang, destLang):
	if MS_TRANSLATOR_CLIENT_ID == "" or MS_TRNASLATOR_CLIENT_SECRET == "":
		return gettext('Error: translation service not configured.')
	try:
		# get access token
		params = urlib.urlencode({
			'client_id': MS_TRANSLATOR_CLIENT_ID,
			'client_secret': MS_TRNASLATOR_CLIENT_SECRET,
